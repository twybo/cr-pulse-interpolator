...
class interp2d_signal:
    ...
    def __call__(self, x, y,
        ...
        """
        # if account_for_timing + account_for_arrival_times > 1:
        #     raise ValueError(f'account_for_timing and  account_for_arrival_times are not compatible,'
